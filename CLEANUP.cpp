...
int main()
{
	int T; //T<=50 indicating the number of test cases to follow
	int n,m; // n is the total number of jobs that must be completed before closing and m is the number of jobs that have already been completed.
	std::cin>>T;
	int temp;
